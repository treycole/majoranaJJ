...
Nx = 3#10 #Number of lattice sites along x-direction
Wj = 2000 #Junction region [A]
nodx = 0#4 #width of nodule
nody = 0#10 #height of nodule
Lx = Nx*ax
...
if PLOT != 'P':
    ...
    #plt.savefig('gapfxgam juncwidth = {} nodwidthx = {} nodwidthy = {} phi = {} Vj = {}.png'.format(Junc_width, Nod_widthx, Nod_widthy, delta, alpha, phi, Vj))
    plt.show()
