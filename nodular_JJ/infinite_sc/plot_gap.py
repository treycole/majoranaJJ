...
fig, axs = plt.subplots(3, 1, gridspec_kw={'hspace':0.82})#, sharey='row')#, sharex='col', sharey='row', gridspec_kw={'hspace':0.5, 'wspace':0.1})
...
axmu.set_xlabel(r'$\mu$ (meV)', size=9, labelpad=-1.5)
axgam.set_xlabel(r'$E_Z$ (meV)', size=9, labelpad=-1.5)
