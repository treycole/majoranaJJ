...
for i in range(steps):
    k = 48
    H = spop.H0(coor, ax, ay, NN, NNb=NNb, alpha=alpha, V=V, gammax=gx, gammaz=gz, mu=mu, qx=0.00287, periodicX=True, periodicY=False)
...
k = 26
H = spop.HBDG(coor, ax, ay, NN, NNb=NNb, Wj=Wj, cutx=cutx, cuty=cuty, alpha=alpha, delta=delta, phi = phi, V=V, gammax=gx, gammaz=gz, mu=mu, qx=0.00287, periodicX=True, periodicY=False)
